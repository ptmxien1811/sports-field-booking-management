...
if __name__ == "__main__":
    with app.app_context():
        ...
        products = [
            ...
            Product(name="Sân tennis tiêu chuẩn màu xanh", price=300000, image="tennis.jpg", category_id=tennis_field.id),
            Product(name="Hồ bơi 125m", price=200000, image="pool.jpg", category_id=swimming_pool.id),
            Product(name="Sân cầu lông tiêu chuẩn 5 sao", price=150000, image="caulong.jpg", category_id=badminton_field.id),
            Product(name="Sân bóng rổ ngoài trời A", price=250000, image="bongro.jpg", category_id=basketball_field.id),
            Product(name="Sân bóng chuyền siêu rộng", price=180000, image="bongchuyen.jpg", category_id=volleyball_field.id),
            Product(name="Sân bóng bàn 2 bàn", price=120000, image="bongban.jpg", category_id=tabletennis_field.id),
            ...
            Product(name="Sân tennis tiêu chuẩn màu vàng", price=300000, image="tennis.jpg", category_id=tennis_field.id),
            ...
            Product(name="Sân cầu lông tiêu chuẩn hạng A", price=150000, image="caulong.jpg", category_id=badminton_field.id),
            Product(name="Sân cầu lông đôi", price=200000, image="caulong.jpg", category_id=badminton_field.id),
            Product(name="Sân bóng rổ ngoài trời B", price=250000, image="bongro.jpg", category_id=basketball_field.id),
            ...
            Product(name="Sân bóng chuyền bãi biển", price=300000, image="bongchuyen.jpg", category_id=volleyball_field.id),
            Product(name="Sân bóng bàn 4 bàn", price=120000, image="bongban.jpg", category_id=tabletennis_field.id),
            Product(name="Sân bóng bàn đôi", price=180000, image="bongban.jpg", category_id=tabletennis_field.id),
            Product(name="Sân pickleball hiện đại mới nhất", price=200000, image="pickleball.jpg", category_id=pickleball_field.id),
            Product(name="Sân pickleball tiêu chuẩn", price=250000, image="pickleball.jpg", category_id=pickleball_field.id)
        ]
